...
- `server/git-pull-only-if-new-changes.sh`: 2.0.4
- `server/generate_goaccess_report.sh`: 1.6.1
- `server/validate_goaccess_reports.sh`: 2.0.0
- `server/pull_repo.sh`: 1.0.0
- `macbook/compress-foty-i-video-v3.sh`: 3.0.0
